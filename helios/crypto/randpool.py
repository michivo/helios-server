...
class RandomPool:
    ...
    def stir (self, s = ''):
        ...
        for i in range(self.bytes // self._hash().digest_size):
            ...
            ix = str(self.__counter) + str(i) + str(self._addPos)
            if isinstance(s, str):
                h.update((str(self.__counter) + str(i) + str(self._addPos) + s).encode())
            else:
                h.update((str(self.__counter) + str(i) + str(self._addPos)).encode() + s)
